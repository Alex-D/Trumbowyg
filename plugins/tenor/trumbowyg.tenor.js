                ...
                init: function (trumbowyg) {
                    ...
                    trumbowyg.addBtnDef('tenor', {
                        fn: function () {
                            ...
                            var BASE_URL = 'https://g.tenor.com/v2/search?ar_range=all&media_filter=gif,tinygif&key=' + trumbowyg.o.plugins.tenor.apiKey
                            ...
                            var searchInput = '<input name="" class="' + prefix + 'tenor-search" placeholder="Search a GIF" autofocus="autofocus">',
                                ...
                                tenorModalHtml = searchInput + closeButton + poweredByTenor + '<div class="' + prefix + 'tenor-modal-scroll"><div class="' + prefix + 'tenor-modal"></div></div>';
